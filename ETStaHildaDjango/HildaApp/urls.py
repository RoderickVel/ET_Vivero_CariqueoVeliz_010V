...
from .views import form_crear_producto, form_mod_cliente, formulario_registro, index, somos, formulario, productos, mostrar_clientes, form_crear_cliente, mostrar_productos, form_crear_producto, form_mod_cliente, form_mod_producto,form_del_cliente,form_del_producto, comprar_prod
...
urlpatterns = [
    ...
    path ('comprar_prod/', comprar_prod, name="comprar_prod"),
]